...
<div class="public-page public-page--legal">
  <div class="container premium-static">
    ...
    <section class="public-hero public-hero--light public-hero--compact">
      ...
      <h1>Termini d’uso</h1>
      <p>Le condizioni che regolano l’utilizzo dei contenuti e dei servizi disponibili su Kairus.</p>
    ...
    @php
      $sections = [
        ['Accettazione', 'Utilizzando il sito Kairus accetti i presenti termini d’uso. Se non li accetti, ti preghiamo di non utilizzare il sito.'],
        ['Contenuti e proprietà intellettuale', 'Tutti i contenuti pubblicati su Kairus — testi, immagini, grafica e codice — sono di proprietà di Andrea Bartiromo e sono protetti dal diritto d’autore. È vietata la riproduzione parziale o totale senza autorizzazione scritta, salvo citazioni brevi con attribuzione e link alla fonte originale.'],
        ...
        ['Accuratezza dei contenuti', 'Kairus si impegna a pubblicare informazioni accurate e verificate. Tuttavia, la scienza è in continua evoluzione: alcune informazioni potrebbero risultare superate. Segnala eventuali errori tramite il form di contatto.'],
        ['Link esterni', 'Il sito può contenere link a fonti esterne. Kairus non è responsabile del contenuto di siti terzi.'],
        ['Limitazione di responsabilità', 'Kairus fornisce i contenuti così come sono, senza garanzie di alcun tipo. Non siamo responsabili per danni diretti o indiretti derivanti dall’uso dei contenuti.'],
