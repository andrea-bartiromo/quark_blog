...
<div class="admin-layout">
  ...
  <aside id="admin-sidebar" class="admin-sidebar" aria-label="Menu amministrazione">
    ...
    @php
      ...
      $isConcepts      = request()->routeIs('admin.concepts.*');
      ...
      // IA sidebar).
      $contenutiOpen = $isArticles || $isCategories || $isMedia || $isComments || $isContentClusters || $isConcepts;
      ...
      $analisiOpen = $isStats || $isSearchOpportunities || $isSearchConsoleCoverage || $isSecondRead || $isEditorialOperations || $isScheduledPublicationsReport || $isEditorialQuality || $isPublicHealth || $isInternalLinkAudit || $isArticleDiscoveryAudit;
    ...
    <nav class="admin-nav" aria-label="Navigazione amministrazione">
      ...
      <x-admin.nav-group label="Contenuti" :open="$contenutiOpen">
        ...
        <x-admin.nav-link :route="route('admin.concepts.index')" :active="$isConcepts" icon="🕸️">Concetti</x-admin.nav-link>
      </x-admin.nav-group>
      ...
      <x-admin.nav-group label="Analisi" :open="$analisiOpen">
        ...
        <x-admin.nav-link :route="route('admin.scheduled-publications-report')" :active="$isScheduledPublicationsReport" icon="🗓️">Pubblicazioni programmate</x-admin.nav-link>
