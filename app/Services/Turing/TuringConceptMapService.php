...
class TuringConceptMapService
{
     ...
     * può essere evocato senza essere ripetuto), e il livello di
     * approfondimento rilevato dagli audit alla data del documento.
     *
     ...
     *
     * @return list<array{argomento: string, capitolo_principale: string, richiami: list<string>, livello_approfondimento: string}>
     */
    public static function concepts(): array
    {
        return [
            ['argomento' => 'Enigma (la macchina)', 'capitolo_principale' => 'enigma', 'richiami' => ['legacy'], 'livello_approfondimento' => 'Approfondito'],
            ['argomento' => 'Bletchley Park', 'capitolo_principale' => 'enigma', 'richiami' => ['legacy'], 'livello_approfondimento' => 'Approfondito'],
            ['argomento' => 'Macchina universale', 'capitolo_principale' => 'computation', 'richiami' => ['ai', 'legacy'], 'livello_approfondimento' => 'Approfondito'],
            ...
            ['argomento' => 'Test di Turing (struttura)', 'capitolo_principale' => 'intelligence', 'richiami' => ['legacy', 'ai'], 'livello_approfondimento' => 'Approfondito'],
            ['argomento' => 'Computing Machinery and Intelligence (1950)', 'capitolo_principale' => 'intelligence', 'richiami' => ['legacy'], 'livello_approfondimento' => 'Approfondito'],
            ...
            ['argomento' => 'Rapporto imitazione / comprensione', 'capitolo_principale' => 'intelligence', 'richiami' => ['ai'], 'livello_approfondimento' => 'Approfondito in Intelligence, da riprendere senza ripetere in AI'],
            ...
            ['argomento' => 'LLM', 'capitolo_principale' => 'ai', 'richiami' => ['intelligence'], 'livello_approfondimento' => 'Solo nominato, da spiegare'],
            ...
            ['argomento' => 'Capacità vs comprensione vs coscienza', 'capitolo_principale' => 'ai', 'richiami' => ['intelligence'], 'livello_approfondimento' => 'Assente, da colmare'],
            ['argomento' => 'Continuità/discontinuità Turing-oggi', 'capitolo_principale' => 'ai', 'richiami' => ['intelligence'], 'livello_approfondimento' => 'Solo accennato, da sviluppare'],
     ...
     *
     * @return array<string, list<array{argomento: string, capitolo_principale: string, richiami: list<string>, livello_approfondimento: string}>>
     */
