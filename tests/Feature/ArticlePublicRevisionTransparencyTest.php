...
class ArticlePublicRevisionTransparencyTest extends TestCase
{
    ...
    public function test_updated_date_is_shown_in_italian_locale_not_as_a_raw_utc_timestamp(): void
    {
        ...
        // italiano già in uso per la data di pubblicazione (es. "12
        // gennaio 2026"), mai un timestamp tecnico ISO/UTC in chiaro.
        preg_match('/Aggiornato il\s*<time datetime="[^"]+">([^<]+)<\/time>/', $response->getContent(), $matches);
