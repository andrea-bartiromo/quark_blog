...
class PublicPageQueryBudgetTest extends TestCase
{
    ...
    public function test_article_page_query_count_is_within_the_post_fix_budget(): void
    {
        ...
        //
        // Budget +1 ulteriore (Mission 43, category source-debt #258): il
        // composer DB-first in AppServiceProvider aggiunge una singola
        // query per-request per popolare $categoryOptions/
        ...
        //
        // Budget +1 ulteriore (Trust Layer — riconciliazione Kairus,
        // trasparenza revisione pubblica): ArticleController::show()
        // chiama ArticleRevisionTransparencyService::lastEditorialUpdate()
        // per decidere se mostrare "Aggiornato il" / dateModified — 1
        // query bounded su article_revisions per pagina, mai per-revisione.
