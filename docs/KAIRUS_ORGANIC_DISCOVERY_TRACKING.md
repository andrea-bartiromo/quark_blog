...
| 5 | Cannibalizzazione di ricerca | in_progress | — | — | vedi nota | — | 1, 2, 4 |
...
Ancora da fare prima del merge: suite completa in background, aprire la
PR, gestire CI/Codex, mergiare, aggiornare questa riga con PR/SHA
definitivi.
