...
| 45 | Protocollo editoriale Trust documentato | in_progress | branch `kairus-cantiere-45-protocollo-editoriale-trust` | — | 4 nuovi test (`TrustEditorialProtocolDriftTest`, verifica route/classi/file citati dal documento esistano davvero + tripwire su NO-GO/Cantiere 44 non costruito); regressione mirata (Trust, 94 test): 94/94 passati | — | 38-43 |
