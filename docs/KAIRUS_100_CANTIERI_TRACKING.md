...
| 41 | Componente accessibile consenso/incertezza | in_progress | branch `kairus-cantiere-41-trust-knowledge-summary-component` | — | 5 nuovi test dedicati (Blade::render, isolamento senza modello Eloquent, incl. escaping XSS); TrustKnowledgeStatementControllerTest + TrustKnowledgeStatementTest invariati (35/35, nessuna regressione dall'estrazione); regressione mirata (Admin + Trust + TopicChips, 1150 test): 1147 passati, 2 pre-esistenti (`ProjectModelTest.php:235`, `ProjectTaskControllerTest.php:193`) | — | 39 |
