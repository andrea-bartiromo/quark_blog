...
| 39 | Campi/validazioni Trust | in_progress | [#596](https://github.com/andrea-bartiromo/quark_blog/pull/596) | — | 4 nuovi test dedicati; suite di regressione mirata (Admin, 1132 test): 1130 passati, 2 pre-esistenti (`ProjectModelTest.php:235`, `ProjectTaskControllerTest.php:193`) | in verifica | 38 |
