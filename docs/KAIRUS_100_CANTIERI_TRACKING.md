...
| 46 | Pacchetto editoriale non pubblico "Mente e comportamento" | in_progress | branch `kairus-cantiere-46-pacchetto-mente-comportamento` | — | 5 nuovi test (`ProvisionNonPublicContentClusterPackageTest`, incl. verifica end-to-end che il pacchetto resti escluso dalla sitemap pubblica anche con un articolo reale pubblicato collegato); regressione mirata (ContentCluster, 267 test): 266/267 passati, 1 pre-esistente non correlato (`ContentClusterAutoLifecycleCompletionTest`) | — | 45 |
