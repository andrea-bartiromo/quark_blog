...
| 47 | Audit attivazione "Mente e comportamento" | in_progress | branch `kairus-cantiere-47-audit-attivazione-mente-comportamento` | — | 8 nuovi test (`ContentClusterPublicationReadinessAuditCommandTest`, incl. verifica end-to-end diretta col comando del Cantiere 46); regressione mirata (ContentCluster, 276 test): 275/276 passati, 1 pre-esistente non correlato (`ContentClusterAutoLifecycleCompletionTest`) | — | 46 |
