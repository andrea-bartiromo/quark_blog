...
| 43 | Metriche privacy-first pilot | in_progress | branch `kairus-cantiere-43-privacy-first-metrics` | — | 6 nuovi test servizio (Unit/Trust) + 6 nuovi test controller (Feature/Admin), incl. verifica strutturale schema (nessuna colonna identificativa) e query budget O(1); regressione mirata (Admin + Trust, 1177 test): 1174 passati, 2 pre-esistenti (`ProjectModelTest.php:235`, `ProjectTaskControllerTest.php:193`) | — | 40 |
