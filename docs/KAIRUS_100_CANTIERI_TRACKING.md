...
| 35 | Admin baseline mensile, denominatori separati | open PR | [#582](https://github.com/andrea-bartiromo/quark_blog/pull/582) | — | 33/33 (nuova suite PublicHealthBaselineService + comando + estensione controller); più ampia (PublicPages+Admin PublicHealthDashboard+Console): 339/339 (3 skip pre-esistenti) | in verifica | 30 |
