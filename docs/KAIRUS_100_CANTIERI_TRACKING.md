...
| 42 | Gate pubblicazione pilot Trust | in_progress | [#601](https://github.com/andrea-bartiromo/quark_blog/pull/601) | — | 6 nuovi test servizio (Unit/Trust) + 6 nuovi test controller (Feature/Admin), inclusa verifica dedicata "nessun form scrivibile"; TrustKnowledgeStatementControllerTest+TrustKnowledgeStatementTest invariati (47/47); regressione mirata (Admin + Trust, 1165 test): 1162 passati, 2 pre-esistenti (`ProjectModelTest.php:235`, `ProjectTaskControllerTest.php:193`) | — | 40, 41 |
