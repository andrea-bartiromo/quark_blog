    ...
    public function run(): void
    {
        ...
        $articles = [
            [
                ...
                'status' => 'published',
                'featured' => true,
                'cover_image' => 'cover-ai-diagnosi-medica.webp',
                'read_minutes' => 8,
                'views' => 1240,
            ...
            [
                ...
                'status' => 'published',
                'featured' => false,
                'cover_image' => 'cover-fotovoltaico-organico.webp',
                'read_minutes' => 5,
                'views' => 876,
            ...
            [
                ...
                'status' => 'published',
                'featured' => false,
                'cover_image' => 'cover-robot-chirurgico.webp',
                'read_minutes' => 6,
                'views' => 654,
            ...
            [
                ...
                'status' => 'published',
                'featured' => false,
                'cover_image' => 'cover-satellite-monitoraggio-clima.webp',
                'read_minutes' => 4,
                'views' => 432,
            ...
            [
                ...
                'status' => 'published',
                'featured' => false,
                'cover_image' => 'cover-ai-futuro-lavoro.webp',
                'read_minutes' => 7,
                'views' => 989,
            ...
            [
                ...
                'status' => 'published',
                'featured' => false,
                'cover_image' => 'cover-batterie-sodio.webp',
                'read_minutes' => 5,
                'views' => 712,
